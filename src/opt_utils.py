...
class opt_driver():
    ...
    def __init__(self, blade_surf: Blade_surf):
        ...
        self.cage = control_cage(blade_props, blade_surf, modal, 10, cage_slice, passengers=True)
...
def plot_cage(cage):
    ...
    fig.savefig('/home/tom/Documents/University/Literature/Note Figures/Cage.png', format='png', transparent=True)
...
def plot_10_modes(modal_data, n=10):
    ...
    fig.legend(('Naca0012', 'Deformed Naca0012'), loc='upper center', ncol=4, fontsize=20, bbox_to_anchor=(0.5, 1.05))

    fig.tight_layout()
    fig.savefig('/home/tom/Documents/University/Latex/SciTech2022OPTPresentation/figs/modes_lite.eps', format='eps', bbox_inches='tight')
...
def plot_10_modes_cage(foil, U, rbf, cage_slice, n=10):
    ...
    fig.legend(('Naca0012', 'Deformed Naca0012', 'Control Cage', 'Deformed Control Cage'), loc='upper center', ncol=4, fontsize=18, bbox_to_anchor=(0.5, 1.025))
    fig.tight_layout()
    fig.savefig('/home/tom/Documents/University/Latex/Scitech2022_OPT/modes.eps', format='eps', bbox_inches='tight')
...
def plot_process(cage):
    ...
    ax1.set_title('Couple control cage section to Naca0012 Aerofoil', fontsize=20)
    ...
    ax2.plot(cage_slice[:, 0] + cage_deformations[:, 0], cage_slice[:, 1] + cage_deformations[:, 1], 'ro-')

    ax2.plot(cage_slice[:, 0], cage_slice[:, 1], c='silver', marker='o', ls='-')
    ...
    ax3.plot(cage_rot_or[:, 0], cage_rot_or[:, 1], c='blue', marker='o', ls='-')
    ...
    ax3.plot(cage_slice[:, 0] + cage_deformations[:, 0], cage_slice[:, 1] + cage_deformations[:, 1], c='silver', marker='o', ls='-')
    ax3.axis('equal')
    ax3.set_xlabel('x/c', fontsize=20)
    ax3.set_ylabel('z', fontsize=20)
    ax3.legend(('Fitted Control cage', 'Transformed Control Cage Deformations', 'Turbine Cross Section'), fontsize=15, loc='upper right')
    ax3.set_title('Transform control cage deformations to turbine axis', fontsize=20)
    ...
    ax4.plot(cage_rot_or[:, 0], cage_rot_or[:, 1], c='silver', marker='o', ls='-')
    ax4.axis('equal')
    ax4.set_xlabel('x/c', fontsize=20)
    ax4.set_ylabel('z', fontsize=20)
    ax4.legend(('Transformed Control Cage Deformations', 'Deformed Turbine Cross Section'), fontsize=15, loc='upper right')
    ax4.set_title('Deform blade surface', fontsize=20)
    ax4.tick_params(axis='both', which='major', labelsize=20)
    
    fig.tight_layout()
    fig.savefig('/home/tom/Documents/University/Literature/Note Figures/def_process.png', format='png', bbox_inches='tight', background='white')
