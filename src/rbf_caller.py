...
aero_nodes[:, 0] = data['Points:0']
aero_nodes[:, 1] = data['Points:1']
aero_nodes[:, 2] = data['Points:2']

pressure_force[:, 0] = data['p_force:0']
pressure_force[:, 1] = data['p_force:1']
pressure_force[:, 2] = data['p_force:2']
